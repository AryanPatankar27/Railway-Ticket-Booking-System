...
public interface PreparedStatement extends Statement {
     ...
     *                         or the SQL statement returns a <code>ResultSet</code>
     *                         object
     * @throws SQLTimeoutException when the driver has determined that the
     *                             timeout value that was specified by the
     *                             {@code setQueryTimeout}
     ...
     *                                            marker in the SQL statement; if a
     ...
     *                                            <code>ROWID</code>,
     *                                            <code>SQLXML</code>
     *                                            or <code>STRUCT</code> data type
     *                                            and the JDBC driver does not
     *                                            support
     *                                            this data type
     */
     ...
     * to an SQL <code>BIT</code> or <code>BOOLEAN</code> value when it sends it to
     * the database.
     *
     * @param parameterIndex the first parameter is 1, the second is 2, ...
     ...
     * @throws SQLException                    if parameterIndex does not correspond
     *                                         to a parameter
     *                                         marker in the SQL statement; if the
     *                                         driver does not support national
     *                                         character sets; if the driver can
     *                                         detect that a data conversion
     *                                         error could occur; if a database
     *                                         access error occurs; or
     *                                         this method is called on a closed
     *                                         <code>PreparedStatement</code>
     * @throws SQLFeatureNotSupportedException if the JDBC driver does not support
     *                                         this method
     ...
     * of characters specified by length otherwise a <code>SQLException</code> will
     * be
     * generated when the <code>PreparedStatement</code> is executed.
     * This method differs from the
     * <code>setCharacterStream (int, Reader, int)</code> method
     ...
     * inputstream must contain the number
     * of characters specified by length otherwise a <code>SQLException</code> will
     * be
     * generated when the <code>PreparedStatement</code> is executed.
     * This method differs from the
     * <code>setBinaryStream (int, InputStream, int)</code>
     * method because it informs the driver that the parameter value should be
     * sent to the server as a <code>BLOB</code>. When the
     * <code>setBinaryStream</code> method is used,
     * the driver may have to do extra work to determine whether the parameter
     * data should be sent to the server as a <code>LONGVARBINARY</code> or a
     * <code>BLOB</code>
     * 
     ...
     *                                         is less than zero or if the number of
     ...
     * <code>setCharacterStream (int, Reader, int)</code> method
     * because it informs the driver that the parameter value should be sent to
     * the server as a <code>NCLOB</code>. When the <code>setCharacterStream</code>
     * method is used, the
     * driver may have to do extra work to determine whether the parameter
     ...
     * <code>Reader</code> then the reader must contain the number of characters
     * specified
     ...
     *                                            is an InputStream
     *                                            or Reader object and the value of
